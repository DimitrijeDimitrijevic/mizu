...
func TestPostEmailToDestinationWithContext_SuccessFirstAttempt(t *testing.T) {
	...
	_, err := PostEmailToDestinationWithContext(context.Background(), "test email", server.URL, "api-key", 3, false, "sender@example.com", "recipient@example.com", "", "", nil, client, slog.New(slog.NewTextHandler(io.Discard, nil)), nil)
...
func TestPostEmailToDestinationWithContext_SuccessAfterRetries(t *testing.T) {
	...
	_, err := PostEmailToDestinationWithContext(context.Background(), "test email", server.URL, "api-key", 4, false, "sender@example.com", "recipient@example.com", "", "", nil, client, slog.New(slog.NewTextHandler(io.Discard, nil)), nil)
...
func TestPostEmailToDestinationWithContext_FailureAllRetries(t *testing.T) {
	...
	maxRetries := 3
	_, err := PostEmailToDestinationWithContext(context.Background(), "test email", server.URL, "api-key", maxRetries, false, "", "", "", "", nil, client, slog.New(slog.NewTextHandler(io.Discard, nil)), nil)
...
func TestPostEmailToDestinationWithContext_NonRetryableError(t *testing.T) {
	...
	client := NewHTTPClient(30*time.Second, 0, 0, 0)
	_, err := PostEmailToDestinationWithContext(context.Background(), "test email", server.URL, "api-key", 3, false, "", "", "", "", nil, client, slog.New(slog.NewTextHandler(io.Discard, nil)), nil)
...
func TestPostEmailToDestinationWithContext_ContextCancellation(t *testing.T) {
	...
	_, err := PostEmailToDestinationWithContext(ctx, "test email", server.URL, "api-key", 5, false, "", "", "", "", nil, client, slog.New(slog.NewTextHandler(io.Discard, nil)), nil)
...
func TestPostEmailToDestinationWithContext_NetworkError(t *testing.T) {
	...
	maxRetries := 3
	_, err := PostEmailToDestinationWithContext(context.Background(), "test email", url, "api-key", maxRetries, false, "", "", "", "", nil, client, slog.New(slog.NewTextHandler(io.Discard, nil)), nil)
...
func TestPostEmailToDestinationWithContext_JunkHeader(t *testing.T) {
	...
	client := NewHTTPClient(30*time.Second, 0, 0, 0)
	_, err := PostEmailToDestinationWithContext(context.Background(), "test email", server.URL, "api-key", 1, true, "", "", "", "", nil, client, slog.New(slog.NewTextHandler(io.Discard, nil)), nil)
	if err != nil {
...
func TestPostEmailToDestinationWithContext_EnvelopeHeaders(t *testing.T) {
	...
	client := NewHTTPClient(30*time.Second, 0, 0, 0)
	_, err := PostEmailToDestinationWithContext(context.Background(), "test email", server.URL, "api-key", 1, false, "sender@example.com", "recipient@example.com", "", "", nil, client, slog.New(slog.NewTextHandler(io.Discard, nil)), nil)
	if err != nil {
		t.Fatalf("Expected no error, but got: %v", err)
	}
...
func TestPostEmailToDestinationWithContext_TraceIDHeader(t *testing.T) {
	...
	_, err := PostEmailToDestinationWithContext(context.Background(), "test email", server.URL, "api-key", 1, false, "", "", testTraceID, "", nil, client, slog.New(slog.NewTextHandler(io.Discard, nil)), nil)
	if err != nil {
		t.Fatalf("Expected no error, but got: %v", err)
	}
